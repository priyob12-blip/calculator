...
if shape == "Trapesium":
    ...
    # HAPUS INPUT PROTEKSI & JENIS TANGKI KARENA TIDAK DIPERLUKAN LAGI DI RUMUS BARU
    ...
    st.markdown("<div class='custom-card'><div class='section-title'>Safety Distance</div>", unsafe_allow_html=True)
    # HAPUS INPUT PROTEKSI & JENIS TANGKI DI SINI JUGA
    cs1, cs2, cs3 = st.columns(3)
...
if st.button("💾 HITUNG SEKARANG", type="primary", use_container_width=True):
    ...
    if d_safety_1 > 0:
        ...
        st.caption(f"Estimasi Kapasitas: {est_kapasitas} KL. Menggunakan nilai mutlak tabel NFPA tanpa faktor reduksi proteksi.")
