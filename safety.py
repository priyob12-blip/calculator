...
# Inisialisasi variabel data tangki (5 Unit)
d_atas_pond = [0.0] * 5
d_bawah_pond = [0.0] * 5
t_pondasis = [0.0] * 5
d_tanks = [0.0] * 5
...
if shape == "Trapesium":
    ...
    lebar_atas = col4.number_input("Lebar Atas Dinding (m)", min_value=0.0, key="l_atas_tr")
    lebar_bawah = col5.number_input("Lebar Bawah Dinding (m)", min_value=0.0, key="l_bawah_tr")
